...
function Hero() {
  ...
  const projects = [
    ...
    { id: 5, title: 'Project 5', description: 'Description for Project 5' },
    {
      id: 6,
      title: 'Expo App',
      description: 'Open my Expo app',
      link: 'https://build-a-burger-3emlcqm30-james-spyrous-projects.vercel.app', // Change to your local server
    },
  ]
        ...
        {selectedProject && selectedItem && (
          <>
            ...
            <div className="bg-gray-700 rounded-lg p-6 flex flex-col justify-between ring-4 ring-cyan-500 h-full">
              ...
              {/* ✅ Show "Open in New Tab" button only if project has a link */}
              {selectedItem.link && (
                <a
                  href={selectedItem.link}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-cyan-500 text-white text-center py-2 px-4 mt-4 rounded-lg hover:bg-cyan-600 transition"
                >
                  Open in New Tab
                </a>
              )}
